...
Returns or sets a  **Boolean** variable that indicates whether the **[NavigationFolder](../../../api/Outlook.NavigationFolder.md)** object is selected for display. Read/write.
...
In either case, an error occurs if the value of this property is set to  **False** for all **NavigationFolder** objects in the parent **[NavigationFolders](../../../api/Outlook.NavigationFolders.md)** collection, or if the **NavigationFolder** object is contained by a navigation module other than the navigation module currently displayed in the Navigation Pane.

The  **[SelectedChange](../../../api/Outlook.NavigationGroups.SelectedChange.md)** event for the parent **NavigationFolders** collection is raised if the value of this property is changed for a **NavigationFolder** object in a **Calendar** navigation module, regardless of the current view.
...
[NavigationFolder Object](../../../api/Outlook.NavigationFolder.md)
