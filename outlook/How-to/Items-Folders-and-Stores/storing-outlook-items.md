...
- Locating a local store (.pst or .ost) for an Exchange server, or a store (.pst) for a POP3, IMAP, or HTTP e-mail server, using the  **[Store.FilePath](../../../api/Outlook.Store.FilePath.md)** property.
