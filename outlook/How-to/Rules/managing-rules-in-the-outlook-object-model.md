...
You can retrieve each rule in a  **Rules** collection by indexing the collection using **[Rules.Item(Index)](rules-item-method-outlook.md)**, with  _Index_ being either the name of the rule (the default property **[Rule.Name](../../../api/Outlook.Rule.Name.md)**), or a value ranging from 1 through the total number of rules in the collection,  **[Rules.Count](../../../api/Outlook.Rules.Count.md)**. 
