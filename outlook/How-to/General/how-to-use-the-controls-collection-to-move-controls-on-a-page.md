...
To use this example, copy this sample code to the Script Editor of a form. To run the code you need to open the form so the **Open** event of the item will activate. Make sure that the form contains a **[CommandButton](../../../api/Outlook.commandbutton.md)** named CommandButton1 and several other controls.
