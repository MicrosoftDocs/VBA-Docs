...
Attempts to resolve a  **[Recipient](../../../api/Outlook.Recipient.md)** object against the Address Book.
...
This Visual Basic for Applications (VBA) example uses  **[CreateItem](../../../api/Outlook.Application.CreateItem.md)** to create a simple task and delegate it as a task request to another user. Before running this example, replace 'Dan Wilson' with a valid recipient name.
