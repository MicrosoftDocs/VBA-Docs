...
1. In the Forms Designer, click the **roperties)** tab.
    
2. To be able to send a copy of the form in email, select the **nd form definition with item** check box.
    
3. To have the form show only for replies to messages, select the **e form only for responses** check box.
