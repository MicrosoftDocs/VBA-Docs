...
1. To switch the form between design mode and run mode (that is, the way the form appears when it is used) do the following. In the Forms Designer, on the **eveloper** tab, in the **Form** group, click **Run This Form**.
    
    **ote** You can test the form outside the Microsoft Outlook design environment by opening a new instance of the form. 
