...
Bitmaps are always transparent on the following controls: [CheckBox](../../../api/Outlook.checkbox.md), [CommandButton](../../../api/Outlook.commandbutton.md), [Label](../../../api/Outlook.label.md), [OptionButton](../../../api/Outlook.optionbutton.md), and [ToggleButton](../../../api/Outlook.togglebutton.md). In Outlook, the following don't support transparent bitmaps: the form, [Frame](../../../api/Outlook.frame.md) control, [Image](../../../api/Outlook.image.md) control, and [MultiPage](../../../api/Outlook.multipage.md) control.
Transparent pictures sometimes have a hazy appearance. If you don't like that appearance, show the picture on a control that supports opaque images. If you use a transparent bitmap on a control that does not support transparent bitmaps, the bitmap appears correctly, but you cannot see what is behind the bitmap.
