...
The functions **[Asc(), AscB(), and AscW()](VBA-Docs/Language/Reference/User-Interface-Help/asc-function.md)** are the opposite of **Chr(), ChrB(), and ChrW().** The **Asc()** functions convert a string to an integer.
