...
An  **Enum** is a[data type](../../Glossary/vbe-glossary.md) that can be used to create groups of related constants (called enumerations). This error has the following causes and solutions:
