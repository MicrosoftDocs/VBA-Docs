...
You can use a  **[TabStrip](tabstrip-control.md)** to view different sets of information for related controls.
 ...
 **Note**  The  **[TabStrip](tabstrip-control.md)** is implemented as a [container](../../Glossary/vbe-glossary.md#container) of a **Tabs** collection, which in turn contains a group of **Tab** objects.

The default property for a  **[TabStrip](tabstrip-control.md)** is the **SelectedItem** property.
The default event for a  **[TabStrip](tabstrip-control.md)** is the Change event.
