...
Returns a [Double](../../Glossary/vbe-glossary.md#double-data-type) specifying the number of periods for an annuity based on periodic, fixed payments and a fixed interest rate.
