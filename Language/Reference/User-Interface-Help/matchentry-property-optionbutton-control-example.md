...
The following example uses the  **MatchEntry** property to demonstrate character matching that is available for **[ComboBox](combobox-control.md)** and **[ListBox](listbox-control.md)**. In this example, the user can set the type of matching with the **[OptionButton](optionbutton-control.md)** controls and then type into the **[ComboBox](combobox-control.md)** to specify an item from its list.
