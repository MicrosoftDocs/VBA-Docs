...
Not all objects support all [properties](../../Glossary/vbe-glossary.md#propertie) and[methods](../../Glossary/vbe-glossary.md#method). This error has the following cause and solution:
