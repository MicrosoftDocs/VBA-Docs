...
The following example demonstrates data movement from a **[TextBox](textbox-control.md)** to a **DataObject**, from a **DataObject** to the Clipboard, and from the Clipboard to another **[TextBox](textbox-control.md)**. The **[PutInClipboard](putinclipboard-method.md)** method transfers the data from a **DataObject** to the Clipboard. The **[SetText](settext-method.md)** and **[Paste](paste-method-microsoft-forms.md)** methods are also used.
