...
<<<<<<< HEAD
- A CTRL+BREAK (Microsoft Windows), ESC (Microsoft Excel) or COMMAND+PERIOD (Macintosh) key combination has been encountered. In the error dialog box, click  **Debug** to enter[break mode](../../Glossary/vbe-glossary.md),  **Continue** to resume, or **End** to stop execution.
=======
