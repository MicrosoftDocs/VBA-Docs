...
The Activate event can occur only when an object is visible. A  **[UserForm](userform-window.md)** loaded with **Load** isn't visible unless you use the **Show** method.
