...
Displays the [Locals window](locals-window.md) and automatically displays all of the [variables](../../Glossary/vbe-glossary.md#variable) in the current stack and their values.
