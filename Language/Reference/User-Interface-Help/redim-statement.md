...
|**Part**|**Description**|
|:-----|:-----|
|**Preserve**|Optional. [Keyword](../../Glossary/vbe-glossary.md) used to preserve the data in an existing[array](../../Glossary/vbe-glossary.md) when you change the size of the last dimension.|
