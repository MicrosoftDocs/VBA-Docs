...
The following example swaps columns of a multicolumn  **[ListBox](listbox-control.md)**. The sample uses the **List** property in two ways:



1. To access and exchange individual values in the  **[ListBox](listbox-control.md)**. In this usage, **List** has subscripts to designate the row and column of a specified value.
    
2. To initially load the  **[ListBox](listbox-control.md)** with values from an array. In this usage, **List** has no subscripts.
