---
title: PPmt function (Visual Basic for Applications)
...
Returns a [Double](../../Glossary/vbe-glossary.md#double-data-type) specifying the principal payment for a given period of an annuity based on periodic, fixed payments and a fixed interest rate.
...
|_per_|Required. [Integer](../../Glossary/vbe-glossary.md#integer-data-type) specifying payment period in the range 1 through _nper_.|
