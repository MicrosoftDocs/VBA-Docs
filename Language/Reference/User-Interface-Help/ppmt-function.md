...
Returns a [Double](../../Glossary/vbe-glossary.md#Double) specifying the principal payment for a given period of an annuity based on periodic, fixed payments and a fixed interest rate.

## Syntax

**PPmt( _rate_**, **_per_**, **_nper_**, **_pv_** [, **_fv_** [, **_type_** ]] **)**
The  **PPmt** function has these[named arguments](../../Glossary/vbe-glossary.md#named-argument):
...
|**_per_**|Required. [Integer](../../Glossary/vbe-glossary.md#Integer) specifying payment period in the range 1 through **_nper_**.|
