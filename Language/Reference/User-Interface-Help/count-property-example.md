...
The following example displays the  **Count** property of the **Controls** collection for the form, and the **Count** property identifying the number of pages and tabs of each **[MultiPage](multipage-control.md)** and **[TabStrip](tabstrip-control.md)**.
 ...
 **Note**  You can add pages to a  **[MultiPage](multipage-control.md)** or add tabs to a **[TabStrip](tabstrip-control.md)**. In Windows, double-click the control, then right-click in the tab area of the control and choose **New Page** from the shortcut menu.
