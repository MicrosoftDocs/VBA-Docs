...
Returns a [Long](../../Glossary/vbe-glossary.md#Long) (long integer) containing the number of objects in a[collection](../../Glossary/vbe-glossary.md#collection). Read-only.
