...
A holding area for formatted text data used in transfer operations. Also holds a list of [formats](../../../language/Glossary/glossary-vba.md#format) corresponding to the pieces of text stored in the **DataObject**.
