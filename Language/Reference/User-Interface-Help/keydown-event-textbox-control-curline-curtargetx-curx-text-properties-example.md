...
The following example tracks the  **CurLine**, **CurTargetX**, and **CurX** property settings in a multiline **[TextBox](textbox-control.md)**. These settings change in the **KeyUp** event as the user types into the **Text** property, moves the insertion point, and extends the selection using the keyboard.
...
3. Add three  **[TextBox](textbox-control.md)** controls named TextBox2, TextBox3, and TextBox4 in a column.
