...
Returns or sets a [Single](../../Glossary/vbe-glossary.md#Single) specifying the location of the top of the window on the screen in[twips](../../Glossary/vbe-glossary.md#twip). Read/write.

## Remarks

The value returned by the  **Top** property depends on whether or not the window is[docked](../../Glossary/vbe-glossary.md#docked), [linked](../../Glossary/vbe-glossary.md#linked), or in docking view.
