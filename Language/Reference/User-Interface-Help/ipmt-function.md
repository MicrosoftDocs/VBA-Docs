...
Returns a [Double](../../Glossary/vbe-glossary.md#Double) specifying the interest payment for a given period of an annuity based on periodic, fixed payments and a fixed interest rate.
