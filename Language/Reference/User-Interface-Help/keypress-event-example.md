...
The following example uses the  **KeyPress** event to copy keystrokes from one **[TextBox](textbox-control.md)** to a second **[TextBox](textbox-control.md)**. The user types into the appropriately marked **[TextBox](textbox-control.md)**.
