...
When the  Locals window is visible, it is automatically updated every time there is a change from Run to[Break mode](../../Glossary/vbe-glossary.md#break-mode) or you navigate in the stack display.
