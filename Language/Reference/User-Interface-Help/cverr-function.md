...
Returns a [Variant](../../Glossary/vbe-glossary.md#Variant) of subtype **Error** containing an[error number](../../Glossary/vbe-glossary.md#error-number) specified by the user.
