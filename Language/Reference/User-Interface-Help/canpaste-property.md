...
If the Clipboard data is in a [format](../../../language/Glossary/glossary-vba.md#format) that the current[target](../../../language/Glossary/glossary-vba.md#target) object does not support, the **CanPaste** property is **False**. For example, if you try to paste a bitmap into an object that only supports text, **CanPaste** will be **False**.
