...
Returns a [Boolean](../../Glossary/vbe-glossary.md#Boolean) value indicating whether or not the **Reference** object points to a valid reference in the[registry](../../Glossary/vbe-glossary.md#registry). Read-only.
 **Return Values**
