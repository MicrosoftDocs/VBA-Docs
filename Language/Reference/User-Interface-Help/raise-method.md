...
|_number_|Required. [Long](../../Glossary/vbe-glossary.md#long-data-type) integer that identifies the nature of the error. Visual Basic errors (both Visual Basic-defined and user-defined errors) are in the range 0-65535. The range 0-512 is reserved for system errors; the range 513-65535 is available for user-defined errors. When setting the **Number** property to your own error code in a class module, you add your error code number to the **vbObjectError**[constant](../../Glossary/vbe-glossary.md#constant). For example, to generate the [error number](../../Glossary/vbe-glossary.md#error-number) 513, assign **vbObjectError** + 513 to the **Number** property.|
