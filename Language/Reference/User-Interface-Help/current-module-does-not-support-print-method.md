...
Not all [methods](../../Glossary/vbe-glossary.md#method) and[properties](../../Glossary/vbe-glossary.md#propertie) are appropriate in all[modules](../../Glossary/vbe-glossary.md#module). This error has the following causes and solutions:
