...
- You tried to use the  **Print** method on an object that can't display anything. For example, you can't use the **Print** method without qualification in a[standard module](../../Glossary/vbe-glossary.md).
