...
|**_class_**|Optional;  **Variant** (**String**). A string representing the[class](../../Glossary/vbe-glossary.md#clas) of the object.|
...
Once an object is activated, you reference it in code using the object variable you defined. In the preceding example, you access [properties](../../Glossary/vbe-glossary.md#propertie) and[methods](../../Glossary/vbe-glossary.md#method) of the new object using the object variable `MyObject`. For example:
