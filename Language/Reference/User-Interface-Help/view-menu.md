...
- [Object Browser](object-browser-command-view-menu.md)
- [Object](object-command-view-menu.md)
- [Project Explorer](project-explorer-command-view-menu.md)
- [Properties window](properties-window-command-view-menu.md)
