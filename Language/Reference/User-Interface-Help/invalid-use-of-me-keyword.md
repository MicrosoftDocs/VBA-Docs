...
The **Me** [keyword](../../Glossary/vbe-glossary.md) can appear in [class modules](../../Glossary/vbe-glossary.md). This error has the following causes and solutions:

- The **Me** keyword appeared in a [standard module](../../Glossary/vbe-glossary.md).
...
- The **Me** keyword appeared on the left side of a **Set** assignment, for example:
  ...
  > [!NOTE] 
  > The **Me** keyword can appear on the left side of a **Let** assignment, in which case the default [property](../../Glossary/vbe-glossary.md) of the object represented by **Me** is set. For example:
