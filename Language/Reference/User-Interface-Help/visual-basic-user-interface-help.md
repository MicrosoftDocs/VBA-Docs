...
- [A form can't be moved or sized while minimized or maximized](a-form-can-t-be-moved-or-sized-while-minimized-or-maximized.md)
- [A module is not a valid type](a-module-is-not-a-valid-type.md)
- [A procedure of that name already exists](a-procedure-of-that-name-already-exists.md)
...
- [A property or method call cannot include a reference to a private object (Error 98)](a-property-or-method-call-cannot-include-a-reference-to-a-private-object-either.md)
...
- [ActiveX component not correctly registered (Error 336)](activex-component-not-correctly-registered-error-336.md)
- [ActiveX control 'item' not found (Error 363)](activex-control-item-not-found-error-363.md)
- [Add-in can't reference project](add-in-can-t-reference-project.md)
- [Ambiguous name detected](ambiguous-name-detected.md)
...
- [Argument not optional (Error 449)](argument-not-optional-error-449.md)
- [Argument required for property Let or property Set](argument-required-for-property-let-or-property-set.md)
- [Array already dimensioned](array-already-dimensioned.md)
- [Array argument must be ByRef](array-argument-must-be-byref.md)
- [Assignment to constant not permitted](assignment-to-constant-not-permitted.md)
- [Automation error (Error 440)](automation-error-error-440.md)
- [Automation object doesn't have a default value (Error 443)](automation-object-doesn-t-have-a-default-value-error-443.md)
- [Bad DLL calling convention (Error 49)](bad-dll-calling-convention-error-49.md)
- [Bad file mode (Error 54)](bad-file-mode-error-54.md)
- [Bad file name or number (Error 52)](bad-file-name-or-number-error-52.md)
...
- [Bad interface for Implements: method does not return HRESULT](bad-interface-for-implements-method-does-not-return-hresult.md)
...
- [Breakpoint not allowed on this line](breakpoint-not-allowed-on-this-line.md)
- [ByRef argument type mismatch](byref-argument-type-mismatch.md)
- [Calling convention not supported by Visual Basic](calling-convention-not-supported-by-visual-basic.md)
- [Cannot define a KWID_tkPUBLIC user-defined type within a private object module](cannot-define-a-kwid_tkpublic-user-defined-type-within-a-private-object-module.md)
- [Cannot display specified name because it is hidden](cannot-display-specified-name-because-it-is-hidden.md)
...
- [Can't create AutoRedraw image (Error 480)](can-t-create-autoredraw-image-error-480.md)
- [Can't create necessary temporary file (Error 322)](can-t-create-necessary-temporary-file-error-322.md)
- [Can't display hidden procedure](can-t-display-hidden-procedure.md)
- [Can't display system information](can-t-display-system-information.md)
- [Can't edit module](can-t-edit-module.md)
- [Can't empty Clipboard (Error 520)](can-t-empty-clipboard-error-520.md)
- [Can't enter break mode at this time](can-t-enter-break-mode-at-this-time.md)
- [Can't execute code in break mode](can-t-execute-code-in-break-mode.md)
- [Can't execute immediate statements in design mode](can-t-execute-immediate-statements-in-design-mode.md)
- [Can't exit design mode because control can't be created](can-t-exit-design-mode-because-control-can-t-be-created.md)
- [Can't find DLL entry point in specified DLL](can-t-find-dll-entry-point-in-specified-dll.md)
...
- [Can't make an assignment to a read-only property](can-t-make-an-assignment-to-a-read-only-property.md)
- [Can't open Clipboard (Error 521)](can-t-open-clipboard-error-521.md)
- [Can't perform operation because the project is protected](can-t-perform-operation-because-the-project-is-protected.md)
- [Can't perform requested operation (Error 17)](can-t-perform-requested-operation-error-17.md)
- [Can't perform requested operation since the module is hidden](can-t-perform-requested-operation-since-the-module-is-hidden.md)
- [Can't place conditional breakpoint on an array](can-t-place-conditional-breakpoint-on-an-array.md)
- [Can't print form image to this type of printer (Error 486)](can-t-print-form-image-to-this-type-of-printer-error-486.md)
- [Can't print minimized form image](can-t-print-minimized-form-image.md)
- [Can't quit at this time](can-t-quit-at-this-time.md)
...
- [Can't rename with different drive (Error 74)](can-t-rename-with-different-drive-error-74.md)
- [Can't save file to TEMP directory (Error 735)](can-t-save-file-to-temp-directory-error-735.md)
- [Can't set the project name at this time](can-t-set-the-project-name-at-this-time.md)
...
- [Case without Select Case](case-without-select-case.md)
- [Circular dependencies between modules](circular-dependencies-between-modules.md)
- [Class doesn't support Automation (Error 430)](class-doesn-t-support-automation-error-430.md)
- [Class is not set (Error 31018)](class-is-not-set-error-31018.md)
...
- [Code resource lock error (Error 455)](code-resource-lock-error-error-455.md)
- [Code resource not found (Error 454)](code-resource-not-found-error-454.md)
- [Compile error in hidden module:](compile-error-in-hidden-modulemodule-name.md)
...
- [Could not start Internet Explorer](could-not-start-internet-explorer.md)
- [Current module does not support Print method](current-module-does-not-support-print-method.md)
- [Cyclic reference of projects not allowed](cyclic-reference-of-projects-not-allowed.md)
- [Data tips Window](data-tips-window.md)
- [Data types displayed in Locals Window](data-types-displayed-in-locals-window.md)
- [Data value named not found (Error 327)](data-value-named-not-found-error-327.md)
- [Definitions of property procedures for the same property are inconsistent](definitions-of-property-procedures-for-the-same-property-are-inconsistent.md)
...
- [Device unavailable (Error 68)](device-unavailable-error-68.md)
- [Disk full (Error 61)](disk-full-error-61.md)
- [Disk not ready (Error 71)](disk-not-ready-error-71.md)
- [Display more load errors?](display-more-load-errors.md)
- [Division by zero (Error 11)](division-by-zero-error-11.md)
- [Do without Loop](do-without-loop.md)
- [Do you want to export specified object before removing it?](do-you-want-to-export-specified-object-before-removing-it.md)
- [Duplicate declaration in current scope](duplicate-declaration-in-current-scope.md)
- [Duplicate definition](duplicate-definition.md)
- [Duplicate Deftype statement](duplicate-deftype-statement.md)
- [Duplicate Option statement](duplicate-option-statement.md)
- [Duplicate procedure name](duplicate-procedure-name.md)
- [Duplicate resources with same type and name](duplicate-resources-with-same-type-and-name.md)
- [Edit can't be undone--proceed anyway?](edit-can-t-be-undone-proceed-anyway.md)
...
- [Else without If](else-without-if.md)
- [ElseIf must be preceded by a matching If or ElseIf and followed by an ElseIf, Else, or EndIf](elseif-must-be-preceded-by-a-matching-if-or-elseif-and-followed-by-an-elseifelse.md)
- [Empty Enum type not allowed](empty-enum-type-not-allowed.md)
- [Empty watch expression](empty-watch-expression.md)
...
- [Error in loading DLL (Error 48)](error-in-loading-dll-error-48.md)
...
- [Event handler is invalid](event-handler-is-invalid.md)
...
- [Exit property not allowed in function or sub](exit-property-not-allowed-in-function-or-sub.md)
- [Exit Sub not allowed in function or property](exit-sub-not-allowed-in-function-or-property.md)
- [Expected array](expected-array.md)
- [Expected End function](expected-end-function.md)
- [Expected End property](expected-end-property.md)
- [Expected End Sub](expected-end-sub.md)
- [Expected End With](expected-end-with.md)
- [Expected function or variable](expected-function-or-variable.md)
- [Expected procedure, not module](expected-procedure-not-module.md)
- [Expected procedure, not project or library](expected-procedure-not-project-or-library.md)
- [Expected procedure, not user-defined type](expected-procedure-not-user-defined-type.md)
- [Expected procedure, not variable](expected-procedure-not-variable.md)
- [Expected sub, function, or property](expected-sub-function-or-property.md)
- [Expected user-defined type, not project](expected-user-defined-type-not-project.md)
- [Expected variable or procedure, not Enum type](expected-variable-or-procedure-not-enum-type.md)
- [Expected variable or procedure, not module](expected-variable-or-procedure-not-module.md)
- [Expected variable or procedure, not project](expected-variable-or-procedure-not-project.md)
- [Expected:](expectedvarious.md)
...
- [File already open (Error 55)](file-already-open-error-55.md)
- [File format no longer supported](file-format-no-longer-supported.md)
- [File is read-only](file-is-read-only.md)
- [File not found (Error 53)](file-not-found-error-53.md)
- [File specified was not found](file-specified-was-not-found.md)
- [Filename or class name not found during Automation operation (Error 432)](filename-or-class-name-not-found-during-automation-operation-error-432.md)
...
- [For Each can only iterate over a collection object or an array](for-each-can-only-iterate-over-a-collection-object-or-an-array.md)
- [For Each control variable must be variant or object](for-each-control-variable-must-be-variant-or-object.md)
- [For Each control variable on arrays must be variant](for-each-control-variable-on-arrays-must-be-variant.md)
- [For Each may not be used on array of user-defined type or fixed-length strings](for-each-may-not-be-used-on-array-of-user-defined-type-or-fixed-length-strings.md)
- [For loop not initialized (Error 92)](for-loop-not-initialized-error-92.md)
...
- [Forward reference to user-defined type](forward-reference-to-user-defined-type.md)
- [Function call on left-hand side of assignment must return variant or object](function-call-on-left-hand-side-of-assignment-must-return-variant-or-object.md)
...
- [Identifier too long](identifier-too-long.md)
...
- [Incorrect OLE version](incorrect-ole-version.md)
- [Input past end of file (Error 62)](input-past-end-of-file-error-62.md)
- [Insufficient Immediate window memory to create variable](insufficient-immediate-window-memory-to-create-variable.md)
...
- [Internal error (Error 51)](internal-error-error-51.md)
- [Invalid Access mode](invalid-access-mode.md)
- [Invalid attribute in sub, function, or property](invalid-attribute-in-sub-function-or-property.md)
- [Invalid Base address](invalid-base-address.md)
...
- [Invalid data type for constant](invalid-data-type-for-constant.md)
...
- [Invalid in Immediate window](invalid-in-immediate-window.md)
- [Invalid inside Enum](invalid-inside-enum.md)
- [Invalid inside procedure](invalid-inside-procedure.md)
- [Invalid length for fixed-length string](invalid-length-for-fixed-length-string.md)
- [Invalid Next control variable reference](invalid-next-control-variable-reference.md)
- [Invalid object use (Error 425)](invalid-object-use-error-425.md)
- [Invalid optional parameter type](invalid-optional-parameter-type.md)
- [Invalid or unqualified reference](invalid-or-unqualified-reference.md)
- [Invalid ordinal (Error 452)](invalid-ordinal-error-452.md)
- [Invalid outside Enum](invalid-outside-enum.md)
- [Invalid outside procedure](invalid-outside-procedure.md)
- [Invalid ParamArray use](invalid-paramarray-use.md)
...
- [Invalid procedure call or argument (Error 5)](invalid-procedure-call-or-argument-error-5.md)
- [Invalid procedure name](invalid-procedure-name.md)
...
- [Invalid qualifier](invalid-qualifier.md)
- [Invalid ReDim](invalid-redim.md)
- [Invalid syntax for conditional compiler constant declarations](invalid-syntax-for-conditional-compiler-constant-declarations.md)
- [Invalid Template](invalid-template.md)
- [Invalid type-declaration character](invalid-type-declaration-character.md)
- [Invalid use of AddressOf operator](invalid-use-of-addressof-operator.md)
- [Invalid use of base class name](invalid-use-of-base-class-name.md)
- [Invalid use of Me keyword](invalid-use-of-me-keyword.md)
- [Invalid use of new keyword](invalid-use-of-new-keyword.md)
- [Invalid use of Null (Error 94)](invalid-use-of-null-error-94.md)
- [Invalid use of object](invalid-use-of-object.md)
- [Invalid watch expression](invalid-watch-expression.md)
...
- [Item is a single-threaded component and cannot be used in multi-threaded projects](item-is-a-single-threaded-component-and-cannot-be-used-in-multi-threaded-project.md)
...
- [Loop without Do](loop-without-do.md)
- [LSet allowed only on strings and user-defined types](lset-allowed-only-on-strings-and-user-defined-types.md)
- [LSet not allowed](lset-not-allowed.md)
...
- [Method or data member not found (Error 461)](method-or-data-member-not-found-error-461.md)
- [Missing end bracket](missing-end-bracket.md)
- [Module not found](module-not-found.md)
- [Module too large](module-too-large.md)
- [Must be first statement on the line](must-be-first-statement-on-the-line.md)
- [Must close or hide topmost modal form first (Error 402)](must-close-or-hide-topmost-modal-form-first-error-402.md)
- [Must specify which item(s) to print](must-specify-which-item-s-to-print.md)
- [Name conflicts with existing module, project, or object library](name-conflicts-with-existing-module-project-or-object-library.md)
- [Name 'item' conflicts with existing module, project, or object library](name-item-conflicts-with-existing-module-project-or-object-library.md)
- [Named argument already specified](named-argument-already-specified.md)
- [Named argument not found (Error 448)](named-argument-not-found-error-448.md)
- [Named arguments not allowed](named-arguments-not-allowed.md)
- [Need property-array index (Error 385)](need-property-array-index-error-385.md)
...
- [No object (Error 31004)](no-object-error-31004.md)
- [No text selected](no-text-selected.md)
...
- [Object does not have a property Let procedure](object-does-not-have-a-property-let-procedure.md)
- [Object does not source Automation events](object-does-not-source-automation-events.md)
- [Object doesn't support current locale setting (Error 447)](object-doesn-t-support-current-locale-setting-error-447.md)
- [Object doesn't support named arguments (Error 446)](object-doesn-t-support-named-arguments-error-446.md)
- [Object doesn't support this action (Error 445)](object-doesn-t-support-this-action-error-445.md)
- [Object doesn't support this property or method (Error 438)](object-doesn-t-support-this-property-or-method-error-438.md)
- [Object library feature not supported](object-library-feature-not-supported.md)
...
- [Object library's language setting incompatible with current project](object-library-s-language-setting-incompatible-with-current-project.md)
- [Object module must implement all procedures in interface](object-module-must-implement-all-procedures-in-interface.md)
- [Object required (Error 424)](object-required-error-424.md)
- [Object server not found (Error 337)](object-server-not-found-error-337.md)
- [Object variable not set (Error 91)](object-variable-not-set-error-91.md)
...
- [Operation not allowed in DLL](operation-not-allowed-in-dll.md)
- [Option Private module not permitted in object module](option-private-module-not-permitted-in-object-module.md)
...
- [Out of stack space (Error 28)](out-of-stack-space-error-28.md)
- [Out of string space (Error 14)](out-of-string-space-error-14.md)
- [Overflow (Error 6)](overflow-error-6.md)
- [ParamArray must be declared as an array of variant](paramarray-must-be-declared-as-an-array-of-variant.md)
- [Path not found (Error 76)](path-not-found-error-76.md)
- [Path/File access error (Error 75)](path-file-access-error-error-75.md)
- [Permission denied (Error 70)](permission-denied-error-70.md)
- [Permission to use object denied (Error 419)](permission-to-use-object-denied-error-419.md)
- [Please see the Readme file for more information on this error](please-see-the-readme-file-for-more-information-on-this-error.md)
...
- [Project file is read-only](project-file-is-read-only.md)
- [Project has been modified. Do you wish to save the changes now?](project-name-has-been-modified-do-you-wish-to-save-the-changes-now.md)
- [Project is unviewable](project-is-unviewable.md)
- [Project not found](project-not-found.md)
- [Property Get can't be executed at run time (Error 393)](property-get-can-t-be-executed-at-run-time-error-393.md)
...
- [Property or method not found (Error 423)](property-or-method-not-found-error-423.md)
- [Property Set can't be executed at run time (Error 382)](property-set-can-t-be-executed-at-run-time-error-382.md)
- [Property Set can't be used with a read-only property (Error 383)](property-set-can-t-be-used-with-a-read-only-property-error-383.md)
- [Property Set not permitted (Error 387)](property-set-not-permitted-error-387.md)
- [Qualified name disallowed in module scope](qualified-name-disallowed-in-module-scope.md)
- [Qualifier must be collection](qualifier-must-be-collection.md)
- [Range has no values](range-has-no-values.md)
- [Replacements too long (Error 746)](replacements-too-long-error-746.md)
- [Requested type library or wizard is not a VBA project](requested-type-library-or-wizard-is-not-a-vba-project.md)
- [Resume without error (Error 20)](resume-without-error-error-20.md)
- [Return without GoSub (Error 3)](return-without-gosub-error-3.md)
- [RSet allowed only on strings](rset-allowed-only-on-strings.md)
- [Run-time error :](run-time-error-number.md)
- [Search string must be specified (VBE)](search-string-must-be-specified-vbe.md)
- [Search string must be specified](search-string-must-be-specified.md)
- [Search string too long or complex](search-string-too-long-or-complex.md)
- [Search text isn't found](search-text-isn-t-found.md)
- [Search text not found (Error 744)](search-text-not-found-error-744.md)
- [Seek failed: can't read/write from the disk](seek-failed-can-t-read-write-from-the-disk.md)
- [Select Case without End Select](select-case-without-end-select.md)
- [Selected watch expression invalid](selected-watch-expression-invalid.md)
- [Set Next statement can only apply to executable lines within current procedure](set-next-statement-can-only-apply-to-executable-lines-within-current-procedure.md)
- [SHARE.EXE required](share-exe-required.md)
- [Specified ActiveX component not correctly registered or not found](specified-activex-component-not-correctly-registered-or-not-found.md)
- [Specified DLL function not found (Error 453)](specified-dll-function-not-found-error-453.md)
- [Specified format doesn't match format of data (Error 461)](specified-format-doesn-t-match-format-of-data-error-461.md)
- [Specified library or project already referenced](specified-library-or-project-already-referenced.md)
- [Statement invalid inside Type block](statement-invalid-inside-type-block.md)
- [Statement invalid outside Type block](statement-invalid-outside-type-block.md)
- [Statement too complex](statement-too-complex.md)
...
- [Subscript out of range (Error 9)](subscript-out-of-range-error-9.md)
- [Syntax error](syntax-error.md)
- [System DLL 'dll' could not be loaded (Error 298)](system-dll-dll-could-not-be-loaded-error-298.md)
...
- [The specified region has been searched and 1 replacement was made](the-specified-region-has-been-searched-and-1-replacement-was-made.md)
...
- [This array is fixed or temporarily locked (Error 10)](this-array-is-fixed-or-temporarily-locked-error-10.md)
- [This command will stop the debugger](this-command-will-stop-the-debugger.md)
- [This component doesn't raise any events](this-component-doesn-t-raise-any-events.md)
- [This component doesn't support this set of events (Error 459)](this-component-doesn-t-support-this-set-of-events-error-459.md)
- [This control can only be used with 'item' designers](this-control-can-only-be-used-with-item-designers.md)
...
- [Too many dimensions](too-many-dimensions.md)
- [Too many DLL application clients](too-many-dll-application-clients.md)
- [Too many files (Error 67)](too-many-files-error-67.md)
- [Too many line continuations](too-many-line-continuations.md)
- [Too many local, nonstatic variables](too-many-local-nonstatic-variables.md)
- [Too many module-level variables](too-many-module-level-variables.md)
...
- [Type mismatch (Error 13)](type-mismatch-error-13.md)
- [Type mismatch: array or user-defined type expected](type-mismatch-array-or-user-defined-type-expected.md)
- [Type not supported in Visual Basic](type-not-supported-in-visual-basic.md)
- [Type-declaration character does not match declared data type](type-declaration-character-does-not-match-declared-data-type.md)
- [Type-declaration character not allowed](type-declaration-character-not-allowed.md)
- [Type-declaration character required](type-declaration-character-required.md)
- [Unable to activate object (Error 31027)](unable-to-activate-object-error-31027.md)
- [Unable to create embedded object (Error 31032)](unable-to-create-embedded-object-error-31032.md)
- [Unable to display Help](unable-to-display-help.md)
- [Unable to read from the disk](unable-to-read-from-the-disk.md)
...
- [Unexpected compile error](unexpected-compile-error.md)
...
- [Unrecognized project language](unrecognized-project-language.md)
- [User interrupt occurred (Error 18)](user-interrupt-occurred-error-18.md)
...
- [Valid values are whole numbers from 1 to 32](valid-values-are-whole-numbers-from-1-to-32.md)
- [Valid values are whole numbers from 2 to 60](valid-values-are-whole-numbers-from-2-to-60.md)
- [Variable not defined](variable-not-defined.md)
...
- [Wend without While](wend-without-while.md)
- [While without Wend](while-without-wend.md)
- [Windowless controls can't have menus](windowless-controls-can-t-have-menus.md)
- [With object must be user-defined type, object, or variant](with-object-must-be-user-defined-type-object-or-variant.md)
- [Wizards can't reference projects](wizards-can-t-reference-projects.md)
- [Wrong number of arguments (Error 450)](wrong-number-of-arguments-error-450.md)
...
- [You must terminate the If block with an End If](you-must-terminate-the-if-block-with-an-end-if.md)