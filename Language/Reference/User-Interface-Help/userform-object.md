...
You can access the collection of [controls](../../Glossary/vbe-glossary.md#control) on a **UserForm** by using the **Controls** collection. For example, to hide all the controls on a **UserForm**, use code similar to the following:
