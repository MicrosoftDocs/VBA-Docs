...
The following example uses the  **TextColumn** property to identify the column of data in a **[ListBox](listbox-control.md)** that supplies data for its **Text** property. This example sets the third column of the **[ListBox](listbox-control.md)** as the text column. As you select an entry from the **[ListBox](listbox-control.md)**, the value from the **TextColumn** will be displayed in the **[Label](label-control.md)**.

This example also demonstrates how to load a multicolumn  **[ListBox](listbox-control.md)** using the **AddItem** method and the **List** property.
