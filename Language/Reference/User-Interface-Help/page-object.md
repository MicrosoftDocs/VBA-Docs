 ...
 **Remarks**
Each  **Page** object contains its own set of controls and does not necessarily rely on other pages in the[collection](vbe-glossary.md) for information. A **Page** inherits some properties from its[container](vbe-glossary.md); the value of each [inherited property](../../../language/Glossary/glossary-vba.md) is set by the container.
