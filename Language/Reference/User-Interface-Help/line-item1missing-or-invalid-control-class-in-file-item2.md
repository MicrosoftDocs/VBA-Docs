...
The ASCII file contains an unknown control [class](../../Glossary/vbe-glossary.md#clas) in the form description, or the class name isn't a valid string in Visual Basic.
