...
> [!NOTE] 
> BACKSPACE is part of the [ANSI character set](../../Glossary/vbe-glossary.md#ansi-character-set), but DELETE is not. Deleting a character in a control by using BACKSPACE causes a KeyPress event; deleting a character by using DELETE doesn't.
