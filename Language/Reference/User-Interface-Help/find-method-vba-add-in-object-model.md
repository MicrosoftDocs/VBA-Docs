...
| _target_|Required. A [String](../../Glossary/vbe-glossary.md#String) containing the text or pattern you want to find.|
| _startline_|Required. A [Long](../../Glossary/vbe-glossary.md#Long) specifying the line at which you want to start the search; will be set to the line of the match if one is found. The first line is number 1.|
...
| _wholeword_|Optional. A [Boolean](../../Glossary/vbe-glossary.md#Boolean) value specifying whether to only match whole words. If **True**, only matches whole words. **False** is the default.|
