...
The  **Image** lets you crop, size, or zoom a picture, but does not allow you to edit the contents of the picture. For example, you cannot use the **Image** to change the colors in the picture, to make the picture[transparent](../../../language/Glossary/glossary-vba.md), or to refine the image of the picture. You must use image editing software for these purposes.
