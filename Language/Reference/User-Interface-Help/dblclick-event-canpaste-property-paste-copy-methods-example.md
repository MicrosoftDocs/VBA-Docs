...
The following example uses the  **CanPaste** property and the **Paste** method to paste a **[ComboBox](combobox-control.md)** from the Clipboard to a **Page** of a **[MultiPage](multipage-control.md)**. This sample also uses the **SetFocus** and **Copy** methods to copy a control from the form to the Clipboard.

The user clicks CommandButton1 to copy the  **[ComboBox](combobox-control.md)** to the Clipboard. The user double-clicks (using the DblClick event) CommandButton1 to paste the **[ComboBox](combobox-control.md)** to the **[MultiPage](multipage-control.md)**.
