...
If the accelerator applies to a  **[Label](label-control.md)**, the control following the **[Label](label-control.md)** in the [tab order](../../Glossary/vbe-glossary.md#tab-order), rather than the  **[Label](label-control.md)** itself, receives the focus.
