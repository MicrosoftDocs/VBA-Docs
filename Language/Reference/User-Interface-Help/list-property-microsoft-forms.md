...
| _Variant_|Optional. The contents of the specified entry in the  **[ListBox](listbox-control.md)** or **[ComboBox](combobox-control.md)**.|
...
Initially,  **[ComboBox](combobox-control.md)** and **[ListBox](listbox-control.md)** contain an empty list.

 **Note**  To specify items you want to display in a  **[ComboBox](combobox-control.md)** or **[ListBox](listbox-control.md)**, use the **AddItem** method. To remove items, use the **RemoveItem** method.
