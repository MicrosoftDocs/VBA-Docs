...
The following example uses the  **EnterKeyBehavior** property to control the effect of ENTER in a **[TextBox](textbox-control.md)**. In this example, the user can specify either a single-line or multiline **[TextBox](textbox-control.md)**.
