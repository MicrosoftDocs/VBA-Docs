...
|**Part**|**Description**|
|:-----|:-----|
| _counter_|Required. Numeric [variable](../../Glossary/vbe-glossary.md#variable) used as a loop counter. The variable can't be a[Boolean](../../Glossary/vbe-glossary.md#Boolean) or an[array](../../Glossary/vbe-glossary.md#array) element.|
