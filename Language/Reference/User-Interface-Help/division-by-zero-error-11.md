...
- The value of an [expression](../../Glossary/vbe-glossary.md) being used as a divisor is zero.
    
    Check the spelling of [variables](../../Glossary/vbe-glossary.md) in the expression. A misspelled variable name can implicitly create a numeric variable that is initialized to zero. Check previous operations on variables in the expression, especially those passed into the[procedure](../../Glossary/vbe-glossary.md) as[arguments](../../Glossary/vbe-glossary.md) from other procedures.
