...
Returns a [Double](../../Glossary/vbe-glossary.md#Double) specifying the future value of an annuity based on periodic, fixed payments and a fixed interest rate.
...
|**_nper_**|Required. [Integer](../../Glossary/vbe-glossary.md#Integer) specifying total number of payment periods in the annuity. For example, if you make monthly payments on a four-year car loan, your loan has a total of 4 * 12 (or 48) payment periods.|
...
|**_pv_**|Optional. [Variant](../../Glossary/vbe-glossary.md#Variant) specifying present value (or lump sum) of a series of future payments. For example, when you borrow money to buy a car, the loan amount is the present value to the lender of the monthly car payments you will make. If omitted, 0 is assumed.|
