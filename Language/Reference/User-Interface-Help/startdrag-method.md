...
The drag action starts at the current mouse pointer position with the current [keyboard state](../../../language/Glossary/glossary-vba.md#keyboard-state) and ends when the user releases the mouse. The effect of the drag-and-drop operation depends on the effect chosen for the drop target.
