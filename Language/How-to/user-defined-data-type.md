...
Any [data type](../Glossary/vbe-glossary.md) you define using the **Type** statement. User-defined data types can contain one or more elements of a data type, an [array](../Glossary/vbe-glossary.md), or a previously defined user-defined type. For example:
