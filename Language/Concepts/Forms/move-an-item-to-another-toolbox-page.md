...
1. Select a control on any page of the **[Toolbox](../../reference/user-interface-help/toolbox.md)**.
...
> [!NOTE] 
> If the page you want to place the control on is not visible, you can increase the width of the Toolbox to display tabs for all the pages, and then drag the control to the appropriate page.
