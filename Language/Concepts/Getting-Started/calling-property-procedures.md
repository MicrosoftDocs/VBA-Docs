...
<<<<<<< HEAD
When you call a  **Property Let** or **Property Set** procedure, one [argument](../../Glossary/vbe-glossary.md) always appears on the right side of the equal sign (**=**).
=======
...
<<<<<<< HEAD
In practice, the only use for property procedures with multiple arguments is to create [arrays](../../Glossary/vbe-glossary.md) of [properties](../../Glossary/vbe-glossary.md).
=======
