...
- Generally, you shouldn't use any names that are the same as the [functions](../../Glossary/vbe-glossary.md#function), [statements](../../Glossary/vbe-glossary.md#statement), and [methods](../../Glossary/vbe-glossary.md#method) in Visual Basic. You end up shadowing the same[keywords](../../Glossary/vbe-glossary.md#keyword) in the language. To use an intrinsic language function, statement, or method that conflicts with an assigned name, you must explicitly identify it. Precede the intrinsic function, statement, or method name with the name of the associated[type library](../../Glossary/vbe-glossary.md#type-library). For example, if you have a variable called  `Left`, you can only invoke the  **Left** function using `VBA.Left`.
