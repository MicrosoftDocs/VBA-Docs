...
-  [Change a Content Control from One Type to Another](../Objects-Properties-Methods/change-a-content-control-from-one-type-to-another.md)
    
-  [Change the Editability of a Content Control](../Objects-Properties-Methods/change-the-editability-of-a-content-control.md)
    
-  [Create a Custom Building Block Gallery](../Objects-Properties-Methods/create-a-custom-building-block-gallery.md)
    
-  [Filter the Building Block List in a Content Control](../Objects-Properties-Methods/filter-the-building-block-list-in-a-content-control.md)
    
-  [Insert a Content Control into a Building Block](../Objects-Properties-Methods/insert-a-content-control-into-a-building-block.md)
...
-  [Set the Building Blocks That You Can Use for a Content Control](../Objects-Properties-Methods/set-the-building-blocks-that-you-can-use-for-a-content-control.md)
