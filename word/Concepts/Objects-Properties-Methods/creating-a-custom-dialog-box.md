...
1.  [Create a UserForm](../Customizing-Word/creating-a-userform.md)
    
    On the  **Insert** menu in the Visual Basic Editor, click **UserForm**.
    
2.  [Add controls to the UserForm](../Customizing-Word/adding-controls-to-a-userform.md)
...
4.  [Initialize the controls](../Customizing-Word/initializing-control-properties-word.md)
...
5.  [Write event procedures](../Customizing-Word/control-and-dialog-box-events-word.md)
...
6.  [Show the dialog box](../Customizing-Word/displaying-a-custom-dialog-box-word.md)
