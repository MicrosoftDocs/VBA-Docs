...
Use the **[Visible](Outlook.TasksModule.Visible.md)** property to determine if the navigation module is visible and the **[Position](Outlook.TasksModule.Position.md)** property to return or set the display position of the navigation module within the navigation pane. Use the **[Name](Outlook.TasksModule.Name.md)** property to return the display name of the **Tasks** navigation module within the navigation pane.
