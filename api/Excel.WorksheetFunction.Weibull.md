...
When alpha = 1, **Weibull** returns the exponential distribution with &nbsp; ![Screenshot that shows the equation that Weibull returns when alpha equals 1.](../images/awfweib3_ZA06051263.gif)
