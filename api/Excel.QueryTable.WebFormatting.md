...
This example adds a new Web query table to the first worksheet in the first workbook, imports all of the webpage formatting applied to the data, and then refreshes the query table.
