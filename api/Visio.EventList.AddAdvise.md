...
| nEventID|The unique identifier of the **Event** object within the **EventList** collection. (Unlike the **Index** property of the **EventList** collection, nEventID does not change as **Event** objects are added to or deleted from the collection.) You can get the **Event** object from **VisEventProc** by using the following code: `vb
