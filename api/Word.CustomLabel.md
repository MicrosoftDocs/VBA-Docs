...
Use the  **[Add](../missing-files/Word/customlabels-add-method-word.md)** method to create a custom label. The following example adds a custom mailing label named "My Label" and sets the page size.
