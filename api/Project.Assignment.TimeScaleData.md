...
| _Type_|Optional|**Long**|The type of timephased data. Can be one of the  **[PjAssignmentTimescaledData](Project.PjAssignmentTimescaledData.md)** constants. The default value is **pjAssignmentTimescaledWork**.|
