...
Gets or sets the shade that is applied to the theme color in the **[BorderColor](access.checkbox.bordercolor.md)** property of the specified object. Read/write **Single**.
