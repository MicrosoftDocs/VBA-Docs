...
For data access pages and forms based on views or non-parameterized SQL queries containing a join, if the **ResyncCommand** property is **Null**, Microsoft Access determines an appropriate query to use for the resync operation. 
