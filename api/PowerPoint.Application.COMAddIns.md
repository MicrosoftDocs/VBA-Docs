...
Returns a reference to the Component Object Model (COM) add-ins currently loaded in Microsoft PowerPoint. These add-ins are listed on the **Ad-Ins** tab in the **PowerPoint Options** dialog box. Read-only.
