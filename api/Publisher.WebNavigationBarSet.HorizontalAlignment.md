...
The  **HorizontalAlignment** property value can be set to any of the **[PbWizardNavBarAlignment](Publisher.PbWizardNavBarAlignment.md)** constants declared in the Microsoft Publisher type library.
