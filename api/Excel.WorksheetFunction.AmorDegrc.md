...
If an asset is purchased in the middle of the accounting period, the prorated depreciation is taken into account. The method is similar to **[AmorLinc](Excel.WorksheetFunction.AmorLinc.md)**, except that a depreciation coefficient is applied in the calculation depending on the life of the assets.
