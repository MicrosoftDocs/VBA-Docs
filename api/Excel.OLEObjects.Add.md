...
| _Top_|Optional| **Variant**|The initial coordinates of the new object, in points, relative to the top of row 1 on a worksheet, or to the top of the chart area on a chart.|
