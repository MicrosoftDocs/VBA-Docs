...
- [DataLabelDisplayFormat (only available in Current Channel)](Access.ChartSeries.DataLabelDisplayFormat.md)
...
- [GridlinesColor (only available in Current Channel)](Access.ChartSeries.GridlinesColor.md)
...
- [ParetoLineColor (only available in Current Channel)](Access.ChartSeries.ParetoLineColor.md)
- [PercentageDataLabelDecimalPlaces (only available in Current Channel)](Access.ChartSeries.PercentageDataLabelDecimalPlaces.md)
...
- [SortOrderType (only available in Current Channel)](Access.ChartSeries.SortOrderType.md)
