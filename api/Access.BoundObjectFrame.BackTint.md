...
Gets or sets the tint that is applied to the theme color in the **[BackColor](access.boundobjectframe.backcolor.md)** property of the specified object. Read/write **Single**.
