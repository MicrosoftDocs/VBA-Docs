...
Use the **[IsTrueColor](Publisher.PictureFormat.IsTrueColor.md)** property to determine whether a picture contains color data of 24 bits per channel or greater.
