---
title: Shape.DrawSpline method (Visio)
...
The  _Flags_ parameter is a bitmask that specifies options for drawing the new shape. Its value should be zero or a combination of one or more of the following values.
