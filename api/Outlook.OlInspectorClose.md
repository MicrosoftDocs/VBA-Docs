...
Used as a parameter to the  **Close** method of item objects and the[Inspector.Close Method (Outlook)](../missing-files/Outlook/inspector-close-method-outlook.md) to indicate the save mode.
