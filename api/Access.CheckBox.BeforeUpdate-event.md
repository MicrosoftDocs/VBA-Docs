...
ms.assetid: cc0951d0-8772-8d76-5eb6-0507026587eb
ms.date: 02/12/2019
...
To run a macro or event procedure when this event occurs, set the **[BeforeUpdate](access.CheckBox.beforeupdate-property.md)** property to the name of the macro or to [Event Procedure].
