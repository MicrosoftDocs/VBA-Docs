---
title: Model3DFormat.IncrementRotationY method (PowerPoint)
keywords: vbapp10.chm743022
f1_keywords:
- vbapp10.chm743022
ms.prod: powerpoint
api_name:
- PowerPoint.Model3DFormat.IncrementRotationY
ms.date: 04/11/2019
localization_priority: Normal
---


# Model3DFormat.IncrementRotationY method (PowerPoint)
...
Use the **[RotationY](PowerPoint.Model3DFormat.RotationY.md)** property to set the absolute rotation of the shape around the y-axis.

To change the rotation of a model around the x-axis, use the **[IncrementRotationX](PowerPoint.Model3DFormat.IncrementRotationX.md)** method. To change the rotation around the z-axis, use the **[IncrementRotationZ](PowerPoint.Model3DFormat.IncrementRotationZ.md)** method.
