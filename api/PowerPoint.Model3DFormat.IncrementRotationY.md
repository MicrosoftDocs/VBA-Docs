...
To change the rotation of a model around the x-axis, use the  **[IncrementRotationX](PowerPoint.Model3DFormat.IncrementRotationX.md)** method. To change the rotation around the z-axis, use the **[IncrementRotationZ](PowerPoint.Shape.IncrementRotationZ.md)** method.
