...
A collection of  **[ListTemplate](listWord.Template.md)** objects in a document, list gallery, or template.
...
After you have returned a  **[ListTemplate](listWord.Template.md)** object, use **ListLevels** (Index), where Index is a number from 1 through 9, to return a single **ListLevel** object. With a **ListLevel** object, you have access to all the formatting properties for the specified list level, such as **Alignment** , **Font** , **NumberFormat** , **NumberPosition** , **NumberStyle** , and **TrailingCharacter** .
