...
Use the **ResultStrU** property to convert between units. For example, you can get the value in inches and then get an equivalent value in centimeters.
...
> [!NOTE] 
> The **Computers and Monitors (US Units)** stencil is available only in Visio Professional.
