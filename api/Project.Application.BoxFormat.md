...
To format Network Diagram boxes using hexadecimal values for  _BorderColor_ and _BackgroundColor_, see the **[BoxFormatEx](../missing-files/Project/application-boxformatex-method-project.md)** method.
