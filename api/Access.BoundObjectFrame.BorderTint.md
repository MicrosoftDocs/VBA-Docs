...
Gets or sets the tint that is applied to the theme color in the **[BorderColor](access.boundobjectframe.bordercolor.md)** property of the specified object. Read/write **Single**.
