...
Initially, a **CmboBox** contains an empty list.

To specify items you want to display in a **CmboBox**, use the  **[AddItem](Outlook.combobox.additem.md)** method. To remove items, use the **[RemoveItem](Outlook.combobox.removeitem.md)** method.
