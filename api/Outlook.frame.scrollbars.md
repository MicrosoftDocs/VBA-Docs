...
If the  **[KeepScrollBarsVisible](Outlook.frame.keepscrollbarsvisible.md)** property is **True**, any scroll bar on a form or page is always visible, regardless of whether the object's contents fit within the object's borders.
