...
| _HasLeaderLines_|Optional| **Variant**|For the  **[Chart](Word.Chart.md)** and **[Series](../missing-files/Word/series-object-word.md)** objects, **True** if the series has leader lines.|
