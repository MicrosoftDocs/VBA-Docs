...
api_name:
- Outlook.togglebutton.backstyle
...
The **BackStyle** property determines whether a control is transparent. If **BackStyle** is 1, the control is not transparent and you cannot see anything behind the control on a form. If **BackStyle** is 0, you can see through the control and look at anything on the form located behind the control. The **[BackColor](Outlook.togglebutton.backcolor.md)** property is only valid if the **BackStyle** property is set to 1.
