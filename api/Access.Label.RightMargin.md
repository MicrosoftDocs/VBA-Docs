...
The following example offsets the caption in the label "EmployeeID_Label" in the "Purchase Orders" form by 100 [twips](../language/glossary/vbe-glossary.md#twip) from the right of the label's border.
