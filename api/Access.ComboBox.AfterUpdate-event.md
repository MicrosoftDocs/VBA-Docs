...
To run a macro or event procedure when this event occurs, set the **[AfterUpdate](access.combobox.afterupdate-property.md)** property to the name of the macro or to [Event Procedure].
