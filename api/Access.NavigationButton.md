...
Use the **[SelectedTab](Access.NavigationControl.SelectedTab.md)** property of the **NavigationControl** object to return the navigation button that is currently selected.
...
- [FontBold](Access.NavigationButton.FontBold.md)
...
- [PressedForeThemeColorIndex](Access.NavigationButton.PressedForeThemeColorIndex.md)
