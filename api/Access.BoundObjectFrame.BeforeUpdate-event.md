...
To run a macro or event procedure when this event occurs, set the **[BeforeUpdate](access.boundobjectframe.beforeupdate-property.md)** property to the name of the macro or to [Event Procedure].
