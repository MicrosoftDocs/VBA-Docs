...
Changes the width of the columns in the specified range to achieve the best fit.
 ...
 _expression_ Required. An expression that returns a [Range](https://docs.microsoft.com/office/vba/api/excel.range(graph%20property)) object. Must be a row or a range of rows, or a column or a range of columns. Otherwise, this method causes an error.
