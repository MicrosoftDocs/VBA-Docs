...
| [SelectedItem](Outlook.multipage.selecteditem.md)|Returns an  **Object** that indicates the currently selected [Page](page-object-outlook-forms-script.md) object. Read-only.|
...
| [TabFixedHeight](Outlook.multipage.tabfixedheight.md)|Returns or sets a  **Single** that represents the height in points of the tabs on a [MultiPage](Outlook.multipage.object-outlook-forms-script.md). Read/write.|
