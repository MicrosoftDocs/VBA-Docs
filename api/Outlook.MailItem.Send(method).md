...
If you use Microsoft Visual Basic Scripting Edition (VBScript) in an Outlook form, you don't create the **[Application](Outlook.Application.md)** object, and you cannot use named constants. This example shows how to forward a mail item using VBScript code.
