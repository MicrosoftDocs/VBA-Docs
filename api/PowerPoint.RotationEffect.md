...
Use the [RotationEffect](PowerPoint.AnimationBehavior.RotationEffect.md)property of the **AimationBehavior** object to return a **RotationEffect** object. The following example refers to the rotation effect for a given animation behavior.
