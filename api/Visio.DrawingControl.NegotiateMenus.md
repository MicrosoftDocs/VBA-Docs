...
> [!NOTE] 
> If **NegotiateMenus** is **True**, the Visio Drawing Control supports OLE2 menu merging. For this merging to function properly, the host container application must implement the **IOleInPlaceFrame** interface correctly. For more information, search for "IOleInPlaceFrame" on MSDN.
