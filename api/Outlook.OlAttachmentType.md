...
Used as an optional parameter to the [Attachments.Add Method (Outlook)](../missing-files/Outlook/attachments-add-method-outlook.md) to specify the attachment type.
