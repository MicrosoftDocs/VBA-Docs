...
Gets or sets a value that represents a color in the applied color theme associated with the **[BorderColor](access.boundobjectframe.bordercolor.md)** property of the specified object. Read/write **Long**.
