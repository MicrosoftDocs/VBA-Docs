...
Gets or sets the tint applied to the theme color in the **[GridlineColor](access.ComboBox.gridlinecolor.md)** property of the specified object. Read/write **Single**.
