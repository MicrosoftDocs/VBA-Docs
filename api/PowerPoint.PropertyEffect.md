...
Use the [PropertyEffect](PowerPoint.AnimationBehavior.PropertyEffect.md)property of the **AimationBehavior** object to return a **PropertyEffect** object. The following example refers to the property effect for a specified animation behavior.
