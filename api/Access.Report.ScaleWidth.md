...
The default setting is the internal width of a report page in [twips](../language/glossary/vbe-glossary.md#twip).
...
Use the **ScaleWidth** property to create a custom coordinate scale for drawing or printing. For example, the statement `ScaleWidth = 100` defines the internal width of the section as 100 units, or one horizontal unit as one one-hundredth of the width.
...
> [!NOTE] 
> The **ScaleWidth** property isn't the same as the **Width** property.
