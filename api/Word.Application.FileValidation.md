...
Files that don't pass validation will be opened in a [Protected View window](Word.ProtectedViewWindow.md). The **FileValidation** property is per session only. If you set the **FileValidation** property, that setting will remain in effect for the entire session the application is open.
