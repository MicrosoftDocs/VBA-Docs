...
The following example shows the difference between the  **[FieldNameToFieldConstant](../missing-files/Project/application-fieldnametofieldconstant-method-project.md)** method and the **FieldConstantToFieldName** method:
