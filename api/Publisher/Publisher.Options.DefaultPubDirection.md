...
The  **DefaultPubDirection** property value can be one of the **[PbDirectionType](Publisher.PbDirectionType.md)** constants declared in the Microsoft Publisher type library.
