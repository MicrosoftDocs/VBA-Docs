...
The default value of the **AtomationSecurity** property is **msoAutomationSecurityByUI**. The value can be one of the following **MsoAutomationSecurity** constants:
