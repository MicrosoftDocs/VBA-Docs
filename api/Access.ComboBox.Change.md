...
To run a macro or event procedure when this event occurs, set the **[OnChange](access.ComboBox.onchange.md)** property to the name of the macro or to [Event Procedure].
