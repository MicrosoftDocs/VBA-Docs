...
To to add a duration to a date for a manually scheduled task, which uses an effective calendar that can include non-working time, use the  **[EffectiveDateAdd](Project.StartDriver.EffectiveDateAdd.md)** property.
