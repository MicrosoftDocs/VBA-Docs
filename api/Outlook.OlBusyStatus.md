...
The user's availability is based on scheduled appointments. See [AppointmentItem.BusyStatus Property (Outlook)](../missing-files/Outlook/appointmentitem-busystatus-property-outlook.md).
