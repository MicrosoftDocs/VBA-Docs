...
A folder can only appear in one navigation group. When adding a **Flder** object to a new navigation group, any references to that **Folder** are removed from any other navigation group of which it was previously a member.
