...
Use the  **[Insert](Publisher.MailMergeDataField.Insert.md)** method of the **[MailMergeDataFields](Publisher.MailMergeDataFields.md)** collection to add a picture data field to a publication's catalog merge area.
...
Use the  **[RemoveCatalogMergeArea](Publisher.Shape.RemoveCatalogMergeArea.md)** method of the **[Shape](Publisher.Shape.md)** object to remove a catalog merge area from a publication.
