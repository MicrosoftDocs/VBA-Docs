...
The  **MouseIcon** property is valid when the **[MousePointer](Outlook.textbox.mousepointer.md)** property is set to 99. The mouse icon of an object is the image that appears when the user moves the mouse across that object.
