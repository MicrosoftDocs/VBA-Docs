...
To edit gridlines where colors can be hexadecimal RGB values, use the  **[GridLinesEditEx](../missing-files/Project/application-gridlineseditex-method-project.md)** method.
