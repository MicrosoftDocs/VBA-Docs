...
Use the **[Trendlines](Excel.Series.Trendlines.md)** method of the **Series** object to return the **Trendlines** collection. The following example displays the number of trendlines for series one in Chart1.
