...
Changing the contents of  **Value** does not change the value of **BoundColumn**. To add or delete entries in a **CmboBox**, you can use the  **[AddItem](Outlook.combobox.additem.md)** or **[RemoveItem](Outlook.combobox.removeitem.md)** method.
