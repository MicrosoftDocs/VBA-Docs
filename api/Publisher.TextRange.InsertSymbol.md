...
If you do not want to replace the range or selection, use the  [TextRange.Collapse Method (Publisher)](../missing-files/Publisher/textrange-collapse-method-publisher.md) before you use this method.
