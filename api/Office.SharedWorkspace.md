...
The **Document**, **Workbook**, and **Presentation** objects also have a **Sync** property that returns a **Sync** object. Use the **Sync** object and its properties and methods to manage the synchronization of the local and the server copies of the shared document.
