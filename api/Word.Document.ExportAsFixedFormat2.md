...
_expression_.**ExportAsFixedFormat2** (_OutputFileName_, _ExportFormat_, _OpenAfterExport_, _OptimizeFor_, _Range_, _From_, _To_, _Item_, _IncludeDocProps_, _KeepIRM_, _CreateBookmarks_, _DocStructureTags_, _BitmapMissingFonts_, _UseISO19005_\1_, _OptimizeForImageQuality_, _FixedFormatExtClassPtr_)
