...
If the cell is in a row in a shape's User-defined Cells, Shape Data, or Connection Points section, the  **RowNameU** property can get or set the universal name of the row. If the cell is not in one of these sections, attempting to get or set the name generates an error.
