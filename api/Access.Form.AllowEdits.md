...
To prevent the OpenForm action from overriding any of these existing property settings, omit the _DataMode_ argument setting so that Microsoft Access will use the property settings defined by the form.
