...
_expression_. `SearchForRecord`(`ObjectType`, `ObjectName`, `Record`, `WhereCondition`)
...
| _Record_|Optional|**AcRecord**|An **[AcRecord](Access.AcRecord.md)** constant that specifies the starting point and direction of the search. The default value is **acFirst**.|
...
The following list demonstrates some things you can do with the **SearchForRecord** method:
