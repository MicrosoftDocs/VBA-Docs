...
The default setting is the internal height of a report page in [twips](../language/glossary/vbe-glossary.md#twip).
...
> [!NOTE] 
> The **ScaleHeight** property isn't the same as the **Height** property.
