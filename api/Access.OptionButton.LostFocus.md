...
To run a macro or event procedure when these events occur, set the **[OnLostFocus](access.OptionButton.onlostfocus.md)** property to the name of the macro or to [Event Procedure].
