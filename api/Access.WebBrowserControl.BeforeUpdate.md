...
|:-----|:-----|:-----|:-----|
| _Cancel_|Required|**Integer**|The setting determines if the **BeforeUpdate** event occurs. Setting the **Cancel** argument to **True** (1) cancels the **BeforeUpdate** event.|
