...
To edit the resource graph styles where the colors can be specified as hexadecimal RGB values, use the  **[ResourceGraphBarStylesEx](Project.Application.ResourceGraphBarStylesEx.md)** method
