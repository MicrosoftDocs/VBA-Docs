...
This VBA example creates a new mail message and uses the **Ad** method to add an **[Action](Outlook.Action.md)** to it. To run this example without any errors, replace 'Dan Wilson' with a valid recipient name.
