...
As with all the properties of the  **[Options](Publisher.Options.md)** object, the current value of the **AddHebDoubleQuote** property becomes the default setting applied to all new publications.
