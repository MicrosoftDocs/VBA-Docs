...
ms.prod: access
api_name:
- Access.OptionGroup.DblClick
ms.assetid: 4ef52706-64dc-38b7-7800-07d3a4d7d7cc
ms.date: 02/12/2019
...
To run a macro or event procedure when this event occurs, set the **[OnDblClick](access.OptionGroup.ondblclick.md)** property to the name of the macro or to [Event Procedure].
