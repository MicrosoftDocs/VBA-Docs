...
Use this method to bind an explicit built-in property or a custom property to a control. You must reference the property by its string name, for example, **Subject**, and not by namespace, for example, `https://schemas.microsoft.com/mapi/proptag/0x0037001E`.
