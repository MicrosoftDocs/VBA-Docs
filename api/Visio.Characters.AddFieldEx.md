...
To add a custom formula field, use the **AddCustomField** or **AddCustomFieldU** method. When you don't pass values (or pass default values) for the optional _LangID_ and _CalendarID_ arguments, **AddFieldEx** acts exactly like **AddField**.
