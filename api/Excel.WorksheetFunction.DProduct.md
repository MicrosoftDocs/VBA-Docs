...
- vbaxl10.chm137145
api_name:
- Excel.WorksheetFunction.DProduct
ms.assetid: 91f30da7-37b3-29d6-a677-95817d9bfe24
ms.date: 05/22/2019
...
| _Arg3_|Required| **Variant**|Criteria is the range of cells that contains the conditions that you specify. Use any range for the criteria argument, as long as it includes at least one column label and at least one cell below the column label in which you specify a condition for the column.|
