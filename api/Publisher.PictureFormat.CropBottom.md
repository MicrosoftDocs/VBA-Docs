...
The valid range of crop values depends on the frame's position and size. For an unrotated frame, the lowest negative value allowed is the distance between the bottom edge of the frame and the bottom edge of the scratch area. The highest positive value allowed is the current frame height.
...
Use the **[CropLeft](Publisher.PictureFormat.CropLeft.md)**, **[CropRight](Publisher.PictureFormat.CropRight.md)**, and **[CropTop](Publisher.PictureFormat.CropTop.md)** properties to crop other edges of a picture or OLE object.
