...
| _PoolResources_|Optional|**Variant**|The  _PoolResources_ argument is ignored in Project. It's retained so that existing macros that use this argument do not cause errors.|
