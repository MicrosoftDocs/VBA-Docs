...
| _Replace_|Optional| **Variant**|Specifies how many replacements are to be made: one, all, or none. Can be any **[WdReplace](Word.WdReplace.md)** constant.|
