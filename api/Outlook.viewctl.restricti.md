...
Comparison operators allowed within the filter expression include >, <, >=, <=, = and <>. Comparisons are not case-sensitive and don't include subject prefixes that are added when a message is replied to or forwarded. 
