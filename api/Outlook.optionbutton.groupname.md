...
api_name:
- Outlook.optionbutton.groupname
...
For example, assume your form includes some option buttons and a **[MultiPage](Outlook.multipage.md)** that also includes option buttons. The option buttons on the **MultiPage** are one group and the buttons on the form are another group. The two groups don't affect each other. Changing the setting of a button on the **MultiPage** does not affect the buttons on the form.
