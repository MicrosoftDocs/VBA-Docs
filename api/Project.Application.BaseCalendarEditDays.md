...
| _WeekDay_|Optional|**Long**|The weekday to change. If  **StartDate** or **EndDate** is specified, **WeekDay** is ignored. Can be one of the **[PjWeekday](Project.PjWeekday.md)** constants.|
