---
title: Shape.GetFormulas method (Visio)
keywords: vis_sdr.chm11216310
f1_keywords:
- vis_sdr.chm11216310
ms.prod: visio
api_name:
- Visio.Shape.GetFormulas
ms.assetid: 51ff9731-802c-2001-c5e6-6f7aeb9d6839
ms.date: 06/08/2017
localization_priority: Normal
---


# Shape.GetFormulas method (Visio)
...
For  **Shape** objects, you can use the **GetFormulas** method to get formulas of any set of cells.

 _SID_SRCStream()_ is an array of 2-byte integers. For **Shape** objects, _SID_SRCStream()_ should be a one-dimensional array of 3 _n_ 2-byte integers for some _n_ >= 1. **GetFormulas** interprets the stream as:
