...
For controls with captions, use the  **[PicturePosition](Outlook.togglebutton.pictureposition.md)** property to specify where to display the picture on the object.
