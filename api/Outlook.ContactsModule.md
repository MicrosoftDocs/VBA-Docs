...
Use the **[Visible](Outlook.ContactsModule.Visible.md)** property to determine if the navigation module is visible and the **[Position](Outlook.ContactsModule.Position.md)** property to return or set the display position of the navigation module within the navigation pane. Use the **[Name](Outlook.ContactsModule.Name.md)** property to return the display name of the **Contacts** navigation module within the navigation pane.
