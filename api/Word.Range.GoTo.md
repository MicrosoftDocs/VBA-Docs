...
|:-----|:-----|:-----|:-----|
| _What_|Optional| **Variant**|The kind of item to which the range is moved. Can be one of the **[wdGoToItem](word.wdgotoitem.md)** constants.|
| _Which_|Optional| **Variant**|The item to which the range is moved. Can be one of the **[wdGoToDirection](word.wdgotodirection.md)** constants.|
