...
|:-----|:-----|
|**acOLECreateEmbed** (0)|Creates an embedded object. To use this setting, you must first set the control's **OLETypeAllowed** property to **acOLEEmbedded** or **acOLEEither**. Set the **Class** property to the type of OLE object that you want to create. Use the **SourceDoc** property to use an existing file as a template.|
...
|**acOLEFetchVerbs** (17)|Updates the list of verbs that an OLE object supports. To display the list of verbs, use the **ObjectVerbs** and **ObjectVerbsCount** properties.|
