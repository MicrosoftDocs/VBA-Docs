...
Used as an optional parameter to the [AddressEntries.Sort Method (Outlook)](../missing-files/Outlook/addressentries-sort-method-outlook.md) to specify the order that address entries should be sorted by the _Property_ parameter.
