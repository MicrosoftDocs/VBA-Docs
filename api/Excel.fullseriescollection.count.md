...
Returns a  **Long** value that represents the number of[Series Object (Excel)](Excel.Series.md) objects in the[FullSeriesCollection Object (Excel)](Excel.fullseriescollection.md) object. Read-only.
