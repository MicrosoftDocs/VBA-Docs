...
For a list of languages and their primary language IDs, see [Language Identifier Constants and Strings](/windows/desktop/Intl/language-identifier-constants-and-strings.md). An exception to this list is Traditional Chinese, which is represented by the value 200.
