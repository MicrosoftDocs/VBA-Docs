...
To edit Gantt bar styles where colors can be hexadecimal RGB values, use the  **[GanttBarEditEx](../missing-files/Project/application-ganttbareditex-method-project.md)** method.
