...
To run a macro or event procedure when this event occurs, set the **[OnDblClick](access.NavigationButton.ondblclick.md)** property to the name of the macro or to [Event Procedure].
