...
This property is only accessible if the active printer is a PostScript printer. Returns a run-time error if a non-PostScript printer is specified. Use the  **[IsPostscriptPrinter](Publisher.AdvancedPrintOptions.IsPostscriptPrinter.md)** property of the **[AdvancedPrintOptions](Publisher.AdvancedPrintOptions.md)** object to determine if the specified printer is a PostScript printer.
