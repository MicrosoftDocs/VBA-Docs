...
Gets or sets the theme color index that represents a color in the applied color theme associated with the **[GridlineColor](access.Label.gridlinecolor.md)** property of the specified object. Read/write **Long**.
