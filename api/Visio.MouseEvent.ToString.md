...
The example contains a class module and two public procedures that are inserted into the **[ThisDocument](../visio/Concepts/about-the-thisdocument-object-visio.md)** project of the active Visio document:
