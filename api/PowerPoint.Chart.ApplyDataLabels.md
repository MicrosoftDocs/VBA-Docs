...
| _HasLeaderLines_|Optional|**Variant**|For the  **[Chart](PowerPoint.Chart.md)** and **[Series](series-object-powerpoint.md)** objects, **True** if the series has leader lines.|
