...
For pictures that are not TrueColor, use the  **[ColorsInPalette](Publisher.PictureFormat.ColorsInPalette.md)** property of the **[PictureFormat](Publisher.PictureFormat.md)** object to determine the number of colors in the picture's palette.
