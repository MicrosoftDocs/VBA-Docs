...
A glyph is a visual representation of a character. Ligatures are two or more glyphs that are represented by what appears to the reader as a single character in order to create more readable or attractive text. Use the [Font.Ligatures Property (Word)](../missing-files/Word/font-ligatures-property-word.md) property to specify the ligatures to apply to a font in Word.
