...
Represents an individual member of a  [Tabs](tabs.md) collection.
...
| [Index](Outlook.tab.index.md)|Returns or sets an  **Integer** that specifies the position of a [Tab](tab.md) object within a [Tabs](tabs.md) collection. Read/write.|
