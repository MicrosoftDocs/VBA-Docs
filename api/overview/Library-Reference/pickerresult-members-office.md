...
|[DisplayName](../../Office.PickerResult.DisplayName.md)|Represents a display name of PickerResult. Read/write|
|[DuplicateResults](../../Office.PickerResult.DuplicateResults.md)|Gets PickerResult collection if the result of resolving results has multiple candidates. Read-only|
|[Fields](../../Office.PickerResult.Fields.md)|Represent field definitions of SubItems in a PickerFields collection. Read-only|
...
|[SIPId](../../Office.PickerResult.SIPId.md)|Is the identifier for Office Communication Server. It's used only for people picking scenario. Read/write|
