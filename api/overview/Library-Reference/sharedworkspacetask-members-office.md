...
|[CreatedBy](../../Office.SharedWorkspaceTask.CreatedBy.md)|Gets the display name of the member who created the shared workspace object. Read-only.|
|[CreatedDate](../../Office.SharedWorkspaceTask.CreatedDate.md)|Gets the date and time when the shared workspace object was created. Read-only.|
|[Creator](../../Office.SharedWorkspaceTask.Creator.md)|Gets a 32-bit integer that indicates the application in which the **SharedWorkspaceTask** object was created. Read-only.|
|[Description](../../Office.SharedWorkspaceTask.Description.md)|Gets or sets a descriptive **String** value for the specified **SharedWorkspaceLink** or **SharedWorkspaceTask** object. Read/write.|
|[DueDate](../../Office.SharedWorkspaceTask.DueDate.md)|Gets or sets the optional due date and time of a **SharedWorkspaceTask** object. Read/write.|
|[ModifiedBy](../../Office.SharedWorkspaceTask.ModifiedBy.md)|Gets the name of the user who last modified the object. Read-only.|
|[ModifiedDate](../../Office.SharedWorkspaceTask.ModifiedDate.md)|Gets the date and time when the **SharedWorkspaceTask** object was last modified. Read-only.|
