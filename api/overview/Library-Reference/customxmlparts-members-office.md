...
|[Creator](../../Office.CustomXMLParts.Creator.md)|Gets a 32-bit integer that indicates the application in which the **CustomXMLParts** object was created. Read-only.|
