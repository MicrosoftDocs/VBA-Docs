...
|[UserId](../../Office.UserPermission.UserId.md)|Gets the e-mail name of the user whose permissions on the active document are determined by the specified **[UserPermission](../../Office.UserPermission.md)** object. Read-only.|
