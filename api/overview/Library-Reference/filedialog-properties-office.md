...
|[ButtonName](../../Office.FileDialog.ButtonName.md)|Sets or gets a  **String** representing the text that is displayed on the action button of a file dialog box. Read/write.|
...
|[InitialFileName](../../Office.FileDialog.InitialFileName.md)|Set or returns a  **String** representing the path or file name that is initially displayed in a file dialog box. Read/write.|
