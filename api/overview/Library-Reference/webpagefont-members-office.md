...
|[FixedWidthFont](../../Office.WebPageFont.FixedWidthFont.md)|Sets or gets the fixed-width font setting in the host application. Read/write.|
|[FixedWidthFontSize](../../Office.WebPageFont.FixedWidthFontSize.md)|Sets or gets the fixed-width font size setting in the host application, in points. Read/write.|
