...
|:-----|:-----|:-----|:-----|
| _ChartFieldType_|Required|[MsoChartFieldType](./overview/msochartfieldtype-enumeration-office.md)|Specifies the type of chart field to insert into a data label.|
