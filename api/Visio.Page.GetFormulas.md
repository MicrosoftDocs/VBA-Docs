...
For  **Page** objects, you can use the **GetFormulas** method to get formulas of any set of cells in any set of shapes of the page or master.

 _SID_SRCStream()_ is an array of 2-byte integers. For **Page** objects, _SID_SRCStream()_ should be a one-dimensional array of 4 _n_ 2-byte integers for _n_ >= 1. The **GetFormulas** method interprets _SID_SRCStream()_ as:
