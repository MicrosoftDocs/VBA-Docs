...
| _MajorAlign_|Optional|**Variant**|The  **[PjAlignment](../missing-files/Project/pjalignment-enumeration-project.md)** enumeration specifies how to align labels within each time period of the middle tier. The default is value is **pjLeft** (0).|
| _MinorAlign_|Optional|**Variant**|The  **[PjAlignment](../missing-files/Project/pjalignment-enumeration-project.md)** enumeration specifies how to align labels within each time period of the bottom tier. The default is value is **pjLeft** (0).|
...
| _TopAlign_|Optional|**Variant**|The  **[PjAlignment](../missing-files/Project/pjalignment-enumeration-project.md)** enumeration specifies how to align labels within each time period of the top tier. The default is value is **pjLeft** (0).|
