...
| _Type_|Optional| **[WdLockType](../missing-files/Word/wdlocktype-enumeration-word.md)**|Specifies the type of lock. The  **WdLockType** specified can only be **wdLockEphemeral** or **WdLockReservation**|
