...
|:-----|:-----|:-----|:-----|
| _RowIndex_|Required| **Variant**|The index number of the cell you want to access, in order from left to right, and then down.<br/><br/>`Range.Item(1)` returns the upper-left cell in the range.<br/><br/>`Range.Item(2)` returns the cell immediately to the right of the upper-left cell. |
...
Syntax 1 uses a row number and a column number or letter as index arguments. For more information about this syntax, see the **[Range](Excel.Range(object).md)** object. 
...
This example fills the range A1:A10 on Sheet1, based on the contents of cell A1. The Cells property returns a Range object.
