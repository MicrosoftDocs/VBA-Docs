...
|:-----|:-----|:-----|:-----|
|_ConnectedShape_|Required| **[Shape](publisher.shape.md)**|The shape to which Microsoft Publisher attaches the beginning of the connector. The specified **Shape** object must be in the same **Shapes** collection as the connector.|
