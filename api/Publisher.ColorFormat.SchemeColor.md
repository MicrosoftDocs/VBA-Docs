...
The  **SchemeColor** property value can be one of the **[PbSchemeColorIndex](Publisher.PbSchemeColorIndex.md)** constants declared in the Microsoft Publisher type library.
