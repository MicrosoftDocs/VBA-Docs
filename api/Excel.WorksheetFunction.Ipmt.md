...
| _Arg2_|Required| **Double**|Per - the period for which you want to find the interest; must be in the range 1 to nper.|
...
| _Arg5_|Optional| **Variant**|Fv - the future value, or a cash balance that you want to attain after the last payment is made. If fv is omitted, it is assumed to be 0 (the future value of a loan, for example, is 0).|
