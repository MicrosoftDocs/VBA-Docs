...
| _ImportMethod_|Optional|**Long**|The method to use when importing data. Can be one of the  **[PjImportMethods](Project.PjImportMethods.md)** constants. The default value is **pjImportNew**.|
...
| _TextFileOrigin_|Optional|**Long**|Specifies the character set under which a text file was created. Can be one of the following  **[PjTextFileOrigin](Project.PjTextFileOrigin.md)** constants: **pjTextOriginWin**, **pjTextOriginDOS**, **pjTextOriginUnicode**, or **pjTextOriginMac**.|
