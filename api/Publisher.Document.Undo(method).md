...
Undoes the last action or a specified number of actions. Corresponds to the list of items that appears when you choose the arrow beside the **Undo** button on the **Standard** toolbar.
...
|:-----|:-----|:-----|:-----|
|_Count_|Optional| **Long**|Specifies the number of actions to be undone. Default is 1, meaning that if omitted, only the last action will be undone.|
