...
The **AfterWrite** event occurs after the **[Write](Outlook.MailItem.Write.md)** event. This event is not cancelable. To determine when the item is unloaded from memory, use the **[Unload](Outlook.MailItem.Unload.md)** event.
