...
You can use a single dialog box to change many properties at the same time. For example, you can use the Format Cells dialog box to change all the properties of the  **[Font](Excel.Font(objec).md)** object.
