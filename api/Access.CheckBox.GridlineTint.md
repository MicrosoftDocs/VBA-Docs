...
Gets or sets the tint applied to the theme color in the **[GridlineColor](access.CheckBox.gridlinecolor.md)** property of the specified object. Read/write **Single**.
