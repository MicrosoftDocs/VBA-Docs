...
Use the **[Visible](Outlook.JournalModule.Visible.md)** property to determine if the navigation module is visible and the **[Position](Outlook.JournalModule.Position.md)** property to return or set the display position of the navigation module within the navigation pane. Use the **[Name](Outlook.JournalModule.Name.md)** property to return the display name of the **Journal** navigation module within the navigation pane.
