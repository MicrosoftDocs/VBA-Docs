...
| _ViewBackgroundColor_|Optional|**Long**|The background color of the view. Can be one of the  **[PjColor](Project.PjColor.md)** constants.|
...
To format the Network Diagram layout using hexadecimal values for  _ViewBackgroundColor_, see the **[BoxLayoutEx](../missing-files/Project/application-boxlayoutex-method-project.md)** method.
