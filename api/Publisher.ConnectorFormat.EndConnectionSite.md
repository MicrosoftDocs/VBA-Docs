...
Use the **[BeginConnectionSite](Publisher.ConnectorFormat.BeginConnectionSite.md)** property to return the site to which the beginning of a connector is connected.
