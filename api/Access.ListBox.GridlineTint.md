...
Gets or sets the tint applied to the theme color in the **[GridlineColor](access.ListBox.gridlinecolor.md)** property of the specified object. Read/write **Single**.
