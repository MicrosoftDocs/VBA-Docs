...
|:-----|:-----|:-----|:-----|
| _Status_|Required|**Integer**|An intrinsic constant that indicates whether a record has been deleted. **acDeleteOK** indicates that the deletion was successful. **acDeleteCancel** indicates that the deletion was canceled in Visual Basic. **acDeleteUserCancel** indicates that the deletion was canceled by the user.|
