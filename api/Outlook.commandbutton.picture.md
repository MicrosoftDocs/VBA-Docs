...
# CommandButton.Picture Property (Outlook Forms Script)
...
For controls with captions, use the  **[PicturePosition](Outlook.commandbutton.pictureposition.md)** property to specify where to display the picture on the object.
