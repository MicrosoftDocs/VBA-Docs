...
When working with Data Access Objects (DAO) or ActiveX Data Objects (ADO), you may need to construct an SQL statement in code. This is sometimes referred to as taking your SQL code "inline." For example, if you are creating a new [QueryDef](../../../api/overview/Access.md) object, you must set its[SQL](../../../api/overview/Access.md) property to a valid SQL string. But if you are using an ADO[Recordset](../../../api/overview/Access.md) object, you must set its[Source](../../../api/overview/Access.md) property to a valid SQL string.
