...
This error occurs when a user specifies that the database open in row/page locking mode, but another user already has the database opened in page locking only mode.
