...
In Microsoft Access database engine databases, this error occurs if you don't select a table name when you create a query. Select at least one table or query.
