...
| _PrintQuality_|Optional|**AcPrintQuality**|A  **[AcPrintQuality](Access.AcPrintQuality.md)** constant that specifies the print quality. the default value is **acHigh**.|
