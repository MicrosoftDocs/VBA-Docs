...
You can use the  **Path** property to determine the location of information stored through the **[CurrentProject](Access.CurrentProject.md)** or **[CodeProject](codeproject-object-access.md)** objects of a project or database.
