...
To return the collection of objects that depend upon the specified  **AccessObject** object, use the **[Dependants](dependencyinfo-dependants-property-access.md)** property of the **[DependencyInfo](Access.DependencyInfo.md)** object.
