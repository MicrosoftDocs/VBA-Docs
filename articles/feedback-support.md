...
|**Documentation updates**| We no longer have resources to respond to new issues. We welcome contributions to the [VBA-Docs repo](https://github.com/MicrosoftDocs/VBA-Docs) that include documentation fixes, code samples, or improved comments.|
