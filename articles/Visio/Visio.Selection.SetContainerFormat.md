...
|:-----|:-----|:-----|
| **visContainerFormatLockMembership**|0|Apply one of the  **[LockMembership](Visio.ContainerProperties.LockMembership.md)** property values, as specified in _FormatValue_.  _FormatValue_ is required, and must be of type **Boolean** (preferred) or or another type that can be converted to **Boolean** .|
