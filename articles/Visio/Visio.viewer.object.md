...
Use the  **[Load](Visio.Load.md)** method to load a Visio drawing into Visio Viewer, and use the **[Unload](Visio.Unload.md)** method to unload the drawing. You can also use the **[SRC](viewer-src-property-visio-viewer.md)** property to get and set the file name and path for the current drawing.
...
Use properties such as  **[BackColor](viewer-backcolor-property-visio-viewer.md)**,  **[GridVisible](Visio.GridVisible.md)**,  **[LayerColor](Visio.LayerColor.md)**,  **[PageColor](Visio.PageColor.md)**,  **[ScrollbarsVisible](Visio.ScrollbarsVisible.md)**, and  **[ToolbarVisible](Visio.ToolbarVisible.md)** to customize the appearance of the Visio Viewer UI.
