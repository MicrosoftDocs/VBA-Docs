...
To add a new  **Page** object to the **Pages** collection from Visual Basic, use the **[Add](Access.Pages.Add.md)** method of the **Pages** collection. To remove an existing **Page** object, use the **[Remove](Access.Pages.Remove.md)** method of the **Pages** collection. To count the number of **Page** objects in the **Pages** collection, use the **[Count](Access.Pages.Count.md)** property of the **Pages** collection.
