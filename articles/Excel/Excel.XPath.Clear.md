...
This method does not clear the data from the cells mapped to the specified XPath. Use the  **[Clear](Excel.Range.Clear.md)** method of the **[Range](Excel.Range(objec).md)** object to clear the data from the cells.
