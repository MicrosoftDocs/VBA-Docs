...
This example disables the default right-click action. For another example, see the [BeforeRightClick](Excel.Workbook.SheetBeforeRightClick.md)event example.
