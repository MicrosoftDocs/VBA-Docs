...
Represents a table shape on a slide. The  **Table** object is a member of the **Shapes** collection. The **Table** object contains the **[Columns](http://msdn.microsoft.com/library/ba2fb830-bb60-b259-3a3f-1281f77d6368%28Office.15%29.aspx)** collection and the **[Rows](PowerPoint.Rows.md)** collection.
