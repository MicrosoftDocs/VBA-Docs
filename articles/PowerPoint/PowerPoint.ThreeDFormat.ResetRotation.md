...
To set the extrusion rotation around the x-axis and the y-axis to anything other than 0 (zero), use the [RotationX](threedformat-rotationx-property-powerpoint.md)and  **[RotationY](threedformat-rotationy-property-powerpoint.md)** properties of the **ThreeDFormat** object. To set the extrusion rotation around the z-axis, use the **[Rotation](PowerPoint.Shape.Rotation.md)** property of the **[Shape](PowerPoint.Shape.md)** object that represents the extruded shape.
