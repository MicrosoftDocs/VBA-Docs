...
To set the rotation of a three-dimensional shape around the x-axis or the y-axis, use the  **[RotationX](threedformat-rotationx-property-powerpoint.md)** property or the **[RotationY](threedformat-rotationy-property-powerpoint.md)** property of the **[ThreeDFormat](PowerPoint.ThreeDFormat.md)** object.
