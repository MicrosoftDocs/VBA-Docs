...
To return a single  **[SmartTag](Access.SmartTag.md)** object, use the **Item** method or use **SmartTags** ( _Index_), where  _Index_ represents the number of the smart tag.
