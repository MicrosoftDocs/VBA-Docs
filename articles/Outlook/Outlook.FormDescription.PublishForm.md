 ...
 **Note**  The  **[PublishForm](formdescription-publishform-method-outlook.md)** method will return an error if the caption ( **[Name](Outlook.FormDescription.Name.md)** ) for the form is not set first.
