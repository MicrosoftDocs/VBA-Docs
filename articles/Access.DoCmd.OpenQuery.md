...
| _DataMode_|Optional|**AcOpenDataMode**|A  **[AcOpenDataMode](Access.AcOpenDataMode.md)** constant that specifies the data entry mode for the query. The default value is **acEdit**.|
