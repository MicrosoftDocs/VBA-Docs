...
The  **Design** property value can be one of the **[PbWizardNavBarDesign](Publisher.PbWizardNavBarDesign.md)** constants declared in the Microsoft Publisher type library.
