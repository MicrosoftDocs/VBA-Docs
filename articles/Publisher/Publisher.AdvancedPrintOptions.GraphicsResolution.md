...
The  **GraphicsResolution** property value can be one of the **[PbPrintGraphics](Publisher.PbPrintGraphics.md)** constants declared in the Microsoft Publisher type library.
