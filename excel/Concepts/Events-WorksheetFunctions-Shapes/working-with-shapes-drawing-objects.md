...
|Object | Description|
|:------|:-----------|
|**[Shapes](../../../api/Excel.Shapes.md)** collection |Use to create shapes and to iterate through all the shapes on a given worksheet. |
|**[ShapeRange](../../../api/Excel.ShapeRange.md)** collection |Use to modify multiple shapes the same way you work with multiple shapes in the user interface. |
|**[Shape](../../../api/Excel.Shape.md)** object |Use to format or modify a single shape. |
...
Use the **[Align](../../../api/Excel.ShapeRange.Align.md)** and **[Distribute](../../../api/Excel.ShapeRange.Distribute.md)** methods to position a set of shapes relative to one another or relative to the document that contains them. 

Use the **[Group](../../../api/Excel.ShapeRange.Group.md)** method or the **[Regroup](../../../api/Excel.ShapeRange.Regroup.md)** method to form a single grouped shape from a set of shapes.
